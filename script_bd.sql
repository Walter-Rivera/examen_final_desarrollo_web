...
ALTER TABLE BITACORA_CLIENTE MODIFY COLUMN ID_OPERACION NUMBER(10) AUTO_INCREMENT;
...
ALTER TABLE DETALLE_SERVICIO ADD CONSTRAINT FK_IDVERSION FOREIGN KEY(ID_VERSION) REFERENCES VERSION(ID_VERSION);
ALTER TABLE DETALLE_SERVICIO ADD CONSTRAINT FK_IDCLIENTE FOREIGN KEY(ID_CLIENTE) REFERENCES CLIENTE(ID_CLIENTE);
ALTER TABLE DETALLE_SERVICIO ADD CONSTRAINT FK_IUUMOD FOREIGN KEY(ID_ULTIMO_USUARIO MODIFICADOR) REFERENCES USUARIO_SISTEMA(ID_USUARIO);
...
REFEFENCES TIPO_MOVIMIENTO_BT_VSOFTWARE(ID_TIPO_MOVIMIENTO);
ALTER TABLE BITACORA_DETALLE_